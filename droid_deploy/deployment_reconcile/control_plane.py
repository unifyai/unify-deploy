...
if TYPE_CHECKING:
    from droid_deploy.assistant_deployments.clients import ClientDeploymentEntry
...
def _load_registry() -> Mapping[str, "ClientDeploymentEntry"]:
    ...
    from droid_deploy.assistant_deployments.clients import _CLIENT_DEPLOYMENTS
...
def _build_scenario_schedule_operations(
    *,
    ...
    from droid_deploy.assistant_deployments.clients import _spec_to_resolved
...
def _scenario_task_activation_action(task: Any) -> str:
    ...
    (:func:`droid_deploy.runtime_reconcile.materialize.materialize_runtime_state`),
    ...
    *,
    ...
    if _scenario_task_activation_action(task) == "deferred":
        ...
        base["deferred_reason"] = (
            "Scenario schedule is private to droid-deploy and its activation "

...
primarily reconciled by ``droid_deploy.scripts.reconcile_deployment`` with the
...
from droid_deploy.timing import log_startup_timing
from droid_deploy.utils.orchestra_client import OrchestraClientError, patch_json
...
def startup_hook(
    ...
    """
    from droid_deploy.startup_config import (
        StartupIdentity,
    ...
    log_startup_timing(
        logger,
        "⏱️ [StartupTiming] droid_deploy.startup_hook identity assistant=%s user=%s org=%s teams=%d",
    ...
    log_startup_timing(
        logger,
        (
            "⏱️ [StartupTiming] droid_deploy.startup_hook resolved "
    ...
    from droid_deploy.runtime_reconcile.context import runtime_identity_from_session
    from droid_deploy.runtime_reconcile.runner import (

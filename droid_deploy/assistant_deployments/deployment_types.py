...
from droid_deploy.assistant_deployments.scenarios.types import ScenarioActivation
from droid_deploy.assistant_deployments.types.pipeline_config import PipelineConfig
...
class DeploymentSpec(BaseModel):
    ...
    integrations: list[str] = Field(
        ...
        description=(
            ...
            "Loaded from droid_deploy.assistant_deployments.integrations.packages."
        ),
    )
    scenarios: list[ScenarioActivation] = Field(
        default_factory=list,
    ...
    console_config: Optional[dict[str, Any]] = Field(
        ...
        description=(
            ...
            "time via droid_deploy.scripts.reconcile_deployment with the "
...
def register_client(
    ...
    *,
    ...
    :func:`~droid_deploy.assistant_deployments.clients.resolve_from_deployments`

...
Usage (build-time):
    python -m droid_deploy.assistant_deployments.integrations.aggregate_demo_sites \\
        --search-paths /app/droid_deploy/assistant_deployments/integrations/packages /app/extra/integrations \\
        --target /app/agent-service/demo-sites

Usage (local dev):
    python -m droid_deploy.assistant_deployments.integrations.aggregate_demo_sites \\
        --search-paths ./droid_deploy/assistant_deployments/integrations/packages \\

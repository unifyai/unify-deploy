...
3. **Entry points**: externally packaged integrations registered under
   ``[project.entry-points."droid_deploy.integrations"]``.
...
_ENTRY_POINT_GROUP = "droid_deploy.integrations"
...
def discover_integrations(
    ...
    3. Entry points: ``[project.entry-points."droid_deploy.integrations"]``

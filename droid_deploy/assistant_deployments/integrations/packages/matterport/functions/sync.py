...
async def run_matterport_sync_tick(
    ...
    if mock:
        from droid_deploy.assistant_deployments.integrations.packages.matterport.functions._sync_models import (
            sync_matterport_models,
        )
        from droid_deploy.assistant_deployments.integrations.packages.matterport.functions._sync_view_stats import (
...
async def probe_matterport_tier(force: bool = False, mock: bool = True) -> dict:
    ...
    from droid_deploy.assistant_deployments.integrations.packages.matterport.functions._capabilities import (
        run_tier_probe,
    )
    from droid_deploy.assistant_deployments.integrations.packages.matterport.functions._sync_helpers import (
        seconds_since,

...
async def run_webex_sync_tick(
    ...
    from droid_deploy.assistant_deployments.integrations.packages.webex.functions._sync_helpers import (
        get_state_watermark,
        load_sync_state,
        seconds_since,
    )
    ...
    if mock:
        from droid_deploy.assistant_deployments.integrations.packages.webex.functions._sync_meetings import (
            sync_webex_meetings,
        )
        from droid_deploy.assistant_deployments.integrations.packages.webex.functions._sync_recordings import (
...
async def probe_webex_tier(force: bool = False, mock: bool = True) -> dict:
    ...
    from droid_deploy.assistant_deployments.integrations.packages.webex.functions._capabilities import (
        run_tier_probe,
    )
    from droid_deploy.assistant_deployments.integrations.packages.webex.functions._sync_helpers import (
        seconds_since,

...
async def run_hubspot_sync_tick(full: bool = False, mock: bool = True) -> dict:
    ...
    from droid_deploy.assistant_deployments.integrations.packages.hubspot.functions._sync_helpers import (
        crm_sync_registry,
    ...
    if mock:
        ...
        from droid_deploy.assistant_deployments.integrations.packages.hubspot.functions._sync_contacts import (
            sync_hubspot_contacts,
        )
        from droid_deploy.assistant_deployments.integrations.packages.hubspot.functions._sync_companies import (
            sync_hubspot_companies,
        )
        from droid_deploy.assistant_deployments.integrations.packages.hubspot.functions._sync_deals import (
            sync_hubspot_deals,
        )
    ...
    async def _dispatch(
        ...
        try:
            module = importlib.import_module(
                f"droid_deploy.assistant_deployments.integrations.packages.hubspot.functions.{module_stem}",
            )

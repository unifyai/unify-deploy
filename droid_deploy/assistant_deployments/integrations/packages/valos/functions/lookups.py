...
async def valos_geocode(query: str, max_results: int = 5) -> dict:
    ...
    from droid_deploy.assistant_deployments.integrations.packages.valos.functions._geocode_fallbacks import (
        nominatim_search,
        postcodes_io_lookup,
    )
    from droid_deploy.assistant_deployments.integrations.packages.valos.functions._lookups_helpers import (
        _normalise_nominatim_response,
        _normalise_os_response,
        _normalise_postcodes_io_response,
        is_uk_postcode,
    )
    from droid_deploy.assistant_deployments.integrations.packages.valos.functions._os_client import (
        os_names_find,
        os_places_find,
    )
...
async def valos_lookup_freeholds(
    ...
    """
    from droid_deploy.assistant_deployments.integrations.packages.valos.functions._propertydata_client import (
...
async def valos_find_care_homes(
    ...
    """
    from droid_deploy.assistant_deployments.integrations.packages.valos.functions._cqc_client import (

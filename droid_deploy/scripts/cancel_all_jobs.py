...
-----
    ...
    python -m droid_deploy.scripts.cancel_all_jobs --bucket droid-pipeline-artifacts-staging list

    # Cancel every non-terminal job (sets status="cancelled" on job.json)
    python -m droid_deploy.scripts.cancel_all_jobs --bucket droid-pipeline-artifacts-staging cancel

    # Delete ALL job artifacts from the bucket (irreversible!)
    python -m droid_deploy.scripts.cancel_all_jobs --bucket droid-pipeline-artifacts-staging delete --confirm
"""

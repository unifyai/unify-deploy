...
# job manifest, then trim stale idle jobs. This is the single authoritative
...
# after the GCS image hash has been updated (new pods pull that image).
#

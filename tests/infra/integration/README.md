...
3. **Test configuration**:
   ```bash
   cp tests/infra/integration/.env.example tests/infra/integration/.env
...
pytest tests/infra/integration/test_invariant_checker.py -v

# Just lifecycle tests (~2 minutes)
pytest tests/infra/integration/test_lifecycle.py -v -s

# Just cleanup safety (~2 minutes)
pytest tests/infra/integration/test_cleanup_safety.py -v

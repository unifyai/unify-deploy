...
import unity_deploy.customization.clients
...
_CLIENTS_DIR = Path(unity_deploy.customization.clients.__file__).parent
    ...
    for client_dir in sorted(_CLIENTS_DIR.iterdir()):
        ...
        try:
            mod = importlib.import_module(
                f"unity_deploy.customization.clients.{client_dir.name}",
            )

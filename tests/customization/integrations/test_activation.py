...
from unity_deploy.customization.deployment_types import DeploymentMapping
from unity_deploy.customization.deployment_types import DeploymentSpec
from unity_deploy.customization.deployment_types import DeploymentTarget
from unity_deploy.customization.deployment_types import SeedLayer
from unity_deploy.customization.integrations.activation import expand_integrations


def _empty_resolved(*, integrations: list[str]) -> ResolvedCustomization:

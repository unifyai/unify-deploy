...
Usage:
    ...
    .venv/bin/python tests/customization/integrations/validate_e2e.py --real   # include real API calls
"""
...
from unity_deploy.customization.integrations.loader import load_integration
...
async def run_validation(include_real: bool = False) -> int:
    ...
    from unity_deploy.customization.integrations.packages.github.functions.users import (
        get_user,
        get_user_repos,
    )
    from unity_deploy.customization.integrations.packages.github.functions.repos import (
        get_repo,
        search_repos,
    )
    from unity_deploy.customization.integrations.packages.github.functions.issues import (
        get_repo_issues,
    )

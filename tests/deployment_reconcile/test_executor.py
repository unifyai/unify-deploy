...
from droid_deploy import deployment_reconcile
from droid_deploy.deployment_reconcile import executor
from droid_deploy.scripts import reconcile_deployment
...
def test_control_plane_apply_reports_missing_optional_assistant(monkeypatch):
    ...
    from droid_deploy.deployment_reconcile import control_plane

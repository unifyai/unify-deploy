...
from tests.communication.infra.integration import conftest as integration_conftest
...
def test_write_failure_artifact_writes_expected_bundle(tmp_path, monkeypatch):
    ...
    artifact_path = integration_conftest._write_failure_artifact(
        {
            "test_nodeid": "tests/communication/infra/integration/test_example.py::test_case",

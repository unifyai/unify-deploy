...
``TEST_CREATE_ASSISTANT_COUNT`` to control scale:
    ...
    # Quick (~5 min)
    TEST_CREATE_ASSISTANT_COUNT=3 pytest tests/communication/infra/integration/test_stress.py -v -s

    # Full stress (~15 min)
    TEST_CREATE_ASSISTANT_COUNT=20 pytest tests/communication/infra/integration/test_stress.py -v -s
"""

...
def renew_watch():
    ...
    for email in emails:
        try:
            ...
            credentials = credentials.with_scopes(["https://www.googleapis.com/auth/gmail.modify"])
...
def process_notification(cloud_event):
    ...
    try:
        ...
        envelope = json.loads(base64.b64decode(cloud_event.data["message"]["data"]).decode("utf-8"))

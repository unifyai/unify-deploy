...
-----
    ...
    python -m unify_deploy.scripts.cancel_all_jobs --bucket unity-pipeline-artifacts-staging list

    # Cancel every non-terminal job (sets status="cancelled" on job.json)
    python -m unify_deploy.scripts.cancel_all_jobs --bucket unity-pipeline-artifacts-staging cancel

    # Delete ALL job artifacts from the bucket (irreversible!)
    python -m unify_deploy.scripts.cancel_all_jobs --bucket unity-pipeline-artifacts-staging delete --confirm
"""

...
async def run_hubspot_sync_tick(full: bool = False, mock: bool = True) -> dict:
    ...
    from unify_deploy.assistant_deployments.integrations.packages.hubspot.functions._sync_helpers import (
        crm_sync_registry,
    ...
    if mock:
        ...
        from unify_deploy.assistant_deployments.integrations.packages.hubspot.functions._sync_contacts import (
            sync_hubspot_contacts,
        )
        from unify_deploy.assistant_deployments.integrations.packages.hubspot.functions._sync_companies import (
            sync_hubspot_companies,
        )
        from unify_deploy.assistant_deployments.integrations.packages.hubspot.functions._sync_deals import (
            sync_hubspot_deals,
        )
    ...
    async def _dispatch(
        ...
        try:
            module = importlib.import_module(
                f"unify_deploy.assistant_deployments.integrations.packages.hubspot.functions.{module_stem}",
            )

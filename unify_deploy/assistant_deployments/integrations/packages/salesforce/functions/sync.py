...
async def run_salesforce_sync_tick(
    ...
    if mock:
        from unify_deploy.assistant_deployments.integrations.packages.salesforce.functions._sync_accounts import (
            sync_salesforce_accounts,
        )
        from unify_deploy.assistant_deployments.integrations.packages.salesforce.functions._sync_opportunities import (

...
async def run_employmenthero_sync_tick(
    ...
    from unify_deploy.assistant_deployments.integrations.packages.employment_hero.functions._sync_helpers import (
        get_state_watermark,
        load_sync_state,
        seconds_since,
    )
    ...
    if mock:
        ...
        from unify_deploy.assistant_deployments.integrations.packages.employment_hero.functions._sync_workforce import (
            sync_employmenthero_workforce,
        )
        from unify_deploy.assistant_deployments.integrations.packages.employment_hero.functions._sync_qualifications import (
            sync_employmenthero_qualifications,
        )
...
async def probe_employmenthero_tier(force: bool = False, mock: bool = True) -> dict:
    ...
    from unify_deploy.assistant_deployments.integrations.packages.employment_hero.functions._capabilities import (
        run_tier_probe,
    )
    from unify_deploy.assistant_deployments.integrations.packages.employment_hero.functions._sync_helpers import (
        seconds_since,

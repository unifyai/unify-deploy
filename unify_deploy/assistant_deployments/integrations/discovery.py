...
3. **Entry points**: externally packaged integrations registered under
   ``[project.entry-points."unify_deploy.integrations"]``.
...
_ENTRY_POINT_GROUP = "unify_deploy.integrations"
...
def discover_integrations(
    ...
    3. Entry points: ``[project.entry-points."unify_deploy.integrations"]``

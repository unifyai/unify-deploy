...
def _clients_dir() -> Path:
    """Absolute path to ``unify_deploy/assistant_deployments/clients/``."""
...
def activate_project(
    ...
    *,
    ...
    unify.init(project_name=project_name, overwrite=overwrite)
    logger.info(
...
def create_pipeline_reporter(
    ...
    *,
    ...
    """
    from unify.file_manager.managers.utils.progress import (
        CompositeReporter,
        ConsoleReporter,
        NoOpReporter,
        create_reporter,

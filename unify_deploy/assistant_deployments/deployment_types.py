...
class DeploymentSpec(BaseModel):
    ...
    integrations: list[str] = Field(
        ...
        description=(
            ...
            "Loaded from unify_deploy.assistant_deployments.integrations.packages."
        ),
    )
    contacts_dir: Optional[Path] = Field(
        default=None,
    ...
    console_config: Optional[dict[str, Any]] = Field(
        ...
        description=(
            ...
            "time via unify_deploy.scripts.reconcile_deployment with the "
...
def register_client(
    ...
    *,
    ...
    :func:`~unify_deploy.assistant_deployments.clients.resolve_from_deployments`
...
def register_layer(
    ...
    """
    from unify_deploy.assistant_deployments.clients import _CLIENT_DEPLOYMENTS

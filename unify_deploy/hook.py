...
primarily reconciled by ``unify_deploy.scripts.reconcile_deployment`` with the
...
def startup_hook(
    ...
    log_startup_timing(
        logger,
        "⏱️ [StartupTiming] unify_deploy.startup_hook identity assistant=%s user=%s org=%s teams=%d",

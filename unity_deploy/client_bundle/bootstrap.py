...
def ensure_offline_client_bundle() -> None:
    ...
    ``unity_deploy.assistant_deployments.clients.<client>`` for imports.
    """

    from unity_deploy.client_bundle.fetch import bundled_client_mode
    from unity_deploy.startup_config import StartupIdentity, resolve_startup_spec

...
async def get_hubspot_deal_velocity_report(
    ...
    return {
        "pipeline_id": pipeline_id,
        "note": (
            "Production implementation aggregates from the synced "

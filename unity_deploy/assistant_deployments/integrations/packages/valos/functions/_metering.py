...
Counters reset at the next call after midnight UTC.  The package is
single-tenant (ClientDelta) today, so the lack of cross-process aggregation
is fine; revisit before opting in any second client.
"""

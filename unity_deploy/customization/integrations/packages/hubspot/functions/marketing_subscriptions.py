...
async def get_contact_subscription_status(
    ...
    return await hubspot_get(f"/communication-preferences/v3/status/email/{contact_email}")
...
async def sync_subscriptions(
    ...
    if mock:
        ...
        return {
            ...
            "metadata": {"object_type": "subscription_types", "mode": "mock",
                         "row_count": len(rows)},
        }
    ...
    if "error" in body:
        return {"schema_version": schema_version, "error": body["error"],
                ...
                "metadata": {"object_type": "subscription_types", "mode": "real",

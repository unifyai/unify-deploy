    ...
    if mock:
        return {
            ...
            "properties": {
                ...
                "quantity": "12", "price": "10000", "amount": "120000",
                "hs_product_id": "300", "hs_object_id": str(line_item_id),
...
async def create_line_item(properties: dict, mock: bool = True) -> dict:
    ...
    if mock:
        base_props = {
            "name": "Line Item", "quantity": "1", "price": "0", "amount": "0",
            "createdate": "2026-04-10T08:00:00Z",
            "hs_lastmodifieddate": "2026-04-10T08:00:00Z",
        }
        return {
...
async def update_line_item(line_item_id: str, properties: dict, mock: bool = True) -> dict:
    ...
    if mock:
        ...
        return {
            "id": str(line_item_id),
            "properties": {**base_props, "hs_object_id": str(line_item_id), **properties},
            "createdAt": "2026-04-10T08:00:00Z",
            "updatedAt": "2026-04-10T08:00:00Z",
            "archived": False,
        }

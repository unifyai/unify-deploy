...
async def log_email(
    ...
    if mock:
        return {
            "id": "E99001",
            "properties": {
                "hs_email_subject": subject, "hs_email_text": body_text,
                "hs_email_html": body_html or body_text,
                "hs_email_direction": direction, "hs_email_status": "SENT",
                "hs_email_from_email": from_email, "hs_email_to_email": to_email,

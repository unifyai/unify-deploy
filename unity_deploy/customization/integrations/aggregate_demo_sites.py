...
Usage (build-time):
    python -m unity_deploy.customization.integrations.aggregate_demo_sites \\
        --search-paths /app/unity_deploy/customization/integrations/packages /app/extra/integrations \\
        --target /app/agent-service/demo-sites

Usage (local dev):
    python -m unity_deploy.customization.integrations.aggregate_demo_sites \\
        --search-paths ./unity_deploy/customization/integrations/packages \\
